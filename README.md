...
We provide the key checkpoints used in our experiments in the paper. The checkpoints are publicly available in the [Google Drive Folder](https://drive.google.com/drive/folders/18dhkXyZQWjdMvlAlxZx3fZhdCZvlj2Hw?usp=sharing). These checkpoints are organized in the following subfolders:
